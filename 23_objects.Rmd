...
1. Download [this data extract from the U.S. National Health Interview Survey 2005](https://docs.google.com/spreadsheet/pub?key=0Agz-ZYJ5rH_WdF91SmhLcV8wMjRtZ3FraGQyVUt2V3c&output=csv). Use `RCurl` as shown above. Call the data `nhis`.
