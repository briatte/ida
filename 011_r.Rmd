...
[R][r] is a software that uses a specific language to manipulate statistical objects. Researchers and statisticians are [increasingly][r-pop] adopting R as their software of choice, and the R user base goes well beyond academia. Many [R User Groups][r-ug] exist on a [worldwide scale][ra-ug]. There is a [huge R community online][pb-rsoc].

[r]: http://www.r-project.org/
[r-pop]: http://r4stats.com/articles/popularity/
[r-ug]: http://www.r-bloggers.com/RUG/
...
[ajd]: http://www.ajdamico.com/
[ajd-asdfree]: http://www.asdfree.com/
[ajd-gh]: https://github.com/ajdamico
...
[cran-us-mac]: http://cran.us.r-project.org/bin/macosx/
[cran-us-win]: http://cran.us.r-project.org/bin/windows/base/
...
[ajd-install-win]: http://www.screenr.com/kzT8
