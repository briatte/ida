...
Form student teams or groups and read all references cited above. Then create the `imf` dataset by downloading the [`8_imf.R`](8_imf.R) script: install any missing packages, and run the first segment of the code. The segment ends with a scatterplot called `imf.plot` that replicates the base structure of the IMF graph:
