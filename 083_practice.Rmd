...
[![FT graph auto](http://im.ft-static.com/content/images/42f72894-14b6-11e2-8cf2-00144feabdc0.img)][ft-giles-1]
...
```{r ols-plot, fig.width = 8, fig.height = 6, echo = FALSE}
...
```{r rvf-plot, fig.width = 8, fig.height = 6, echo = FALSE}
...
```{r outliers-plot, fig.width = 8, fig.height = 6, echo = FALSE}
