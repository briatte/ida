...
- __Use a modern and secure browser__. Anything but Microsoft Internet Explorer should do. Try [Apple Safari](https://www.apple.com/safari/), [Google Chrome](http://www.google.com/chrome) or [Mozilla Firefox](https://www.mozilla.org/en-US/firefox/new/). Use bookmarks to keep track of the different pages that will be referred to in class: start by bookmarking the [course index](index.html).
