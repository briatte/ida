...
## @knitr plot-assange-auto, message = FALSE, fig.width = 12, fig.height = 9, tidy = FALSE, cache = TRUE, warning = FALSE
# Load ggnet function.
...
## @knitr plot-obama-auto, message = FALSE, fig.width = 12, fig.height = 9, tidy = FALSE, cache = TRUE, warning = FALSE
# Target locations
