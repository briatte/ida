...
Another visualization consists in stacking the entire series and showing it as an [area][ggplot2-area] of a common space represeting 100% of voting intentions. Be careful with interpretation here: the electorate changes from an election to another, and voting intentions are not actual votes. Slight errors appear at the top of the graph due to rounding approximations in the polling data.
