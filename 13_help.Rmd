...
This command will bring up help for a whole package:
...
The output of that method won't be that helpful in most cases. When stuck, what you _really_ want to do is read from a handbook like Teetor's _R Cookbook_.
...
> __Next week__: [Basic R operators](20_basics.html). Do not forget to read the assigned handbook chapters!
