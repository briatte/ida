...
__To follow and complete this course__, you will need a laptop with Internet access and an interest in building both computer and statistical skills. Please bring your laptop at every class and make sure that you know how to use it to work (e.g. how to manage files and folders, install an application, unzip files, switch between windows, etc.).
