...
Finally, this course is very influenced by the development of data visualization. To get a taste of it, see [this selection of "dataviz" methods](http://selection.datavisualization.ch/), read some articles from [Robert Kosara's blog](http://eagereyes.org/) on computational graphics, and see [Simon Jackman's neat graphs](http://jackman.stanford.edu/blog/?p=2620) of Barack Obama's electoral victory in 2012.
...
__Exams are not a crucial element of the course__: you will be assessed mainly through your level of engagement with the coursework, which will consist in forming a small-scale student data team to publish short projects. The precise content of the projects will be decided in class, following each team's research interests.

__Feedback is a crucial element of the course__: you will be assessed in part through the level of feedback--either positive or negative--that you provide inc lass. You will be required to tell us whether you find the methods we teach useful, what applications you can imagine for them, and whether we managed to make you understand how it works (and if not, why).

__Graphics are a crucial element of the course__: [junk charts](http://junkcharts.typepad.com/) have [dire consequences](http://andrewgelman.com/2011/09/worst-graph-of-the-year/) on how we learn about events, so we will focus a lot of our attention to the construction and examination of graphics. Data visualization will be complemented with essential statistical analysis along the way.
...
We hope to present the results of this course at the [R 2013](http://r2013-lyon.sciencesconf.org/) and [ECPR Bordeaux](http://ecprnet.eu/Events/PanelList.aspx?EventID=5&SectionID=52) conference, in order to report on how well (or how badly!) the experiment ran. Your identity will *never* be disclosed, but we will take notes on your feedback during class and use it to write our report.

__Next__: [Readings](02_readings.html)