...
1. Download [this data extract from the U.S. National Health Interview Survey 2005](https://raw.github.com/briatte/ida/master/data/nhis.2005.txt). Use `RCurl` as shown above. Call the data `nhis`.
