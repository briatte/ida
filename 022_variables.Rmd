...
In R, everything is an object. The list of objects in memory `ls()` is an object itself, as shown in the example below, which lists and wipes all objects from the workspace:
...
if (!file.exists(file <- "data/grades.txt")) {
  # Locate the data.
  grades <- "https://raw.github.com/briatte/ida/master/data/grades.txt"
  # Download the data.
  grades <- download(grades, file, mode = "wb")
}
# Load the data.
...
# Add color.
qplot(data = grades, x = value, color = variable, fill = variable, 
...
# Download the data if needed.
if (!file.exists(file <- "data/nhis.txt")) {
  # Locate the data.
  nhis <- "https://raw.github.com/briatte/ida/master/data/nhis.txt"
  # Download the data.
  nhis <- download(nhis, file, mode = "wb")
}
# Load the data.
