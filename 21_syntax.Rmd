...
```{r broken-hello-world, eval=FALSE}
# This will break.
print(Hello World!)
...
A very important aspect of R syntax is *assignment*. To put some values into an object, you need two things, separated by a right-left arrow (or by a single equal sign if you prefer). The example below creates an object that holds my Body Mass Index. I can then call the object at a later stage.
