...
As a very quick exercise, create the `bmi.quetelet` function that computes the BMI in its [original metric units](https://en.wikipedia.org/wiki/Body_mass_index), and compute your own figure.
