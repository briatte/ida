...
[wiki-bc]: https://en.wikipedia.org/wiki/B%C3%A9zier_curve
[ds-bezier]: http://is-r.tumblr.com/post/38459242505/beautiful-network-diagrams-with-ggplot2
...
[wiki-fdg]: https://en.wikipedia.org/wiki/Force-based_algorithms
...
```{r ggnet-exploration, message = FALSE}
# Load functions.
...
[wiki-degree]: https://en.wikipedia.org/wiki/Degree_(graph_theory)
[wiki-centrality]: https://en.wikipedia.org/wiki/Centrality
[wiki-betweenness]: https://en.wikipedia.org/wiki/Betweenness_centrality
