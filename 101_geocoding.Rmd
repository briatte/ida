...
```{r africa-osm-auto, warning = FALSE, message = FALSE, fig.width = 12, fig.height = 9, tidy = FALSE, cache = TRUE}
...
The `get_map` function puts more than one map service at your fingertips: here's an example with the [Stamen watercolor][stamen] map. This map still uses a different color for each country and has a few more plot options to remove the unnecessary axis and title information. It would be easy to write a quick map function to avoir recoding each plot (have a try).
