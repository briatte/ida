...
all <- dir(pattern="[0-9]+(.*).Rmd")[c(1:4,8,12:26)]
# knitr setup
...
# get HTML
html <- dir(pattern="(index|[0-9]+(.*)).html|style.css")
# set path
...
> __Part 1: Introduction to Statistical Computing__. The course starts by one month dedicated to setting up R and learning its basic functionalities. This part of the course is designed to teach everyone some essentials of statistical computing. It assumes no particular knowledge of computers.
...
> __Part 2: Introduction to Statistical Analysis__. The course continues by showcasing some statistical techniques, from 
