...
[jo-rapp]: https://github.com/jeroenooms/RAppArmor
...
[regex]: http://stat.ethz.ch/R-manual/R-patched/library/base/html/regex.html
...
[jdc-r]: http://www.johndcook.com/R_language_for_programmers.html
[pb-hell]: http://www.burns-stat.com/pages/Tutor/R_inferno.pdf
[tt]: http://www.twotorials.com/ "R Twotorials (Anthony J. Damico)"

The course itself is documented in more detail on its [wiki][ida-wiki]. You might also turn to the `README` files that were written for the course [code][ida-code] and [datasets][ida-data] if you need additional details on the contents and examples of each session, which will give you an overview of the material that we will survey in our time together.

[ida-wiki]: https://github.com/briatte/ida/wiki
[ida-code]: https://github.com/briatte/ida/#readme
[ida-data]: https://github.com/briatte/ida/tree/master/data#readme
