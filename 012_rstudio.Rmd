...
Finally, set your course folder as the default working directory in RStudio's preferences. Open the preferences with &#8984;-, (Mac) or from the "Tools > Options" menu. The very first preference is the default working directory, which should be set to your `IDA` folder:
...
> __Next__: [Practice session](013_practice.html).
