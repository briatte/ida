...
data = "data/olympics.2012.txt"
# Identify the data source.
url = "https://raw.github.com/briatte/ida/master/data/Olympics.100m.txt"
# Download the data if needed.
if(!file.exists(data)) download(url, data, mode = "wb")
# Read the data.
olympics <- read.table(data, stringsAsFactors=FALSE)
# Check result.
head(olympics)
```
