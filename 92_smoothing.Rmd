...
Let's start with assault deaths in the United States. The data are from the [Bureau of Justice Statistics](http://bjs.ojp.usdoj.gov/). For state-by-state and OECD vs. USA comparative data, see [Kieran Healy's plots](https://github.com/kjhealy/assault-deaths).
...
# Read as CSV.
bjs.data <- read.csv("data/bjs2007.csv", sep = " ")
# Check first rows.
head(bjs.data)
# Check final rows.
tail(bjs.data)
