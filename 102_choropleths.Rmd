...
David Sparks has posted his [chloropleth](https://dsparks.wordpress.com/2011/02/21/choropleth-tutorial-and-regression-coefficient-plots/) code, as well as examples of U.S. maps [with ggplot2](http://is-r.tumblr.com/post/37708137014/us-state-maps-using-map-data). In the future, there's a chance that he will also post his code for [isarithmic map](https://dsparks.wordpress.com/2012/07/18/mapping-public-opinion-a-tutorial/):
