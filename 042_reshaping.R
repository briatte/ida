...
## @knitr dwnominate1, results='hide', message=FALSE
library(foreign)
library(Hmisc)
...
## @knitr dwnominate2, message=FALSE
library(plyr)
...
## @knitr csi-collapse, results='hide'
# Load packages.
library(reshape)
